...
-- Source: examples/metaflow/jira-kanban.agent.json
BEGIN;
...
VALUES ('77947897-ec67-5a36-ab7f-72bd34210d1b'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Issue', '{"titleKey":"title","primaryKey":"id","properties":{"status":{"displayName":"Status","type":"string","required":true,"picklistConfig":{"allowMultiple":false,"options":["To Do","In Progress","Done"]}}}}'::jsonb)
...
INSERT INTO metaflow.object_types (id, tenant_id, display_name, config)
VALUES ('36e58c7d-e07b-53a2-867b-7ce7d324a7bf'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'User', '{"titleKey":"name","primaryKey":"id","properties":{"name":{"displayName":"Name","type":"string","required":true}}}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  display_name = EXCLUDED.display_name,
  config = EXCLUDED.config,
  updated_at = now();
...
VALUES ('4772417a-0805-5a1d-beab-fb4bae043265'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Start Progress', '{}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  display_name = EXCLUDED.display_name,
  config = EXCLUDED.config,
  updated_at = now();
