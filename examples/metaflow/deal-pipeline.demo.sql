...
-- Source: examples/metaflow/deal-pipeline.demo.json
BEGIN;
...
INSERT INTO metaflow.object_types (id, tenant_id, display_name, config)
VALUES ('8c3accd7-b377-5dc2-909a-81e6f297bca8'::uuid, '00000000-0000-0000-0000-000000000025'::uuid, 'Company', '{"titleKey":"name","primaryKey":"id","properties":{"name":{"displayName":"Company Name","type":"string","required":true},"industry":{"displayName":"Industry","type":"string","required":false}}}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  display_name = EXCLUDED.display_name,
  config = EXCLUDED.config,
  updated_at = now();
...
INSERT INTO metaflow.relationships (
  ...
  'deal', 'contacts',
  '4a8d810e-270c-5535-b341-70ef0a22b5a2'::uuid, NULL, NULL, NULL, '{"notes":"Backed by junction entity with role metadata"}'::jsonb
) ON CONFLICT (id) DO UPDATE SET
  display_name = EXCLUDED.display_name,
  cardinality = EXCLUDED.cardinality,
  source_object_type_id = EXCLUDED.source_object_type_id,
...
INSERT INTO metaflow.action_types (id, tenant_id, display_name, config)
VALUES ('ec649922-e418-58b2-b328-c803a70c9c15'::uuid, '00000000-0000-0000-0000-000000000025'::uuid, 'Log Follow-up Note', '{"executionType":"declarative","description":"Adds next-step note and updates activity timestamp without stage transition","parameters":[{"name":"deal","type":"object-reference","displayName":"Deal","required":true,"objectTypeId":"89b89cb2-99b0-507f-b638-2bb8f801cf07"},{"name":"note","type":"string","displayName":"Follow-up Note","required":true}],"rules":[{"type":"modify_object","objectParameter":"deal","properties":{"nextStep":{"source":"parameter","parameterName":"note"},"lastActivityAt":{"source":"current_timestamp"}}}]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  display_name = EXCLUDED.display_name,
  config = EXCLUDED.config,
  updated_at = now();
